...
| Repaginação da UI prepara o lugar dos cargos, sem construí-los | Cargos exigiriam reescrever a autorização do backend, hoje só por participação, e o teste de SRV-06 depende dela valer em todo lugar. Preparar a UI custa quase nada; construir cargos é fase própria | — Pending |
